...
\vspace{-10pt}
$phone$\\[.1cm] % sort of hack because I can't get the spacing right
...
$if(intro)$
$intro.tagline$\\
{\footnotesize\textsc{$intro.keywords$}}
$endif$
...
\noindent
$for(experience)$
\note{$experience.years$}\textsc{$experience.employer$}, \emph{$experience.job$}\\
{\footnotesize\textsc{$experience.keywords$}}\\[.15cm]
$experience.description$\\[.5cm]
$endfor$
...
$for(projects)$
\note{$projects.years$}\emph{$projects.name$}\\
{\footnotesize\textsc{$projects.keywords$}}\\[.15cm]
$projects.description$\\
$if(projects.url)$
\href{https://$projects.url$}{$projects.url$}\\
$endif$
[.5cm]
$endfor$
$endif$
